'use strict';
// All Data
function Book(name, imgLink, imgPath, link) {
  // Book title
  this.name= name;
  // Image
...
const front_end_books = [
  ...
  new Book('front_end_books', 5, '', '/pdf-folder/book1.pdf'),
  new Book('front_end_books', 5, '', '/pdf-folder/book1.pdf'),
  new Book('front_end_books', 5, '', '/pdf-folder/book1.pdf'),
];
const back_end_books = [
  ...
  new Book('back_end_book', 5, '', '/pdf-folder/book1.pdf'),
  new Book('back_end_book', 5, '', '/pdf-folder/book1.pdf'),
  new Book('back_end_book', 5, '', '/pdf-folder/book1.pdf'),
];
console.log(front_end_books);
// get element by id
...
for (let i = 0; i < 5; i++) {
  ...
  book_a.href=front_end_books[i].imgLink;
  book_img.src = front_end_books[i].imgPath;
  span_button1.textContent = 'Read';
  span_button2.textContent = 'Download';
  span_a1.href = front_end_books[i].imgLink;
...
for (let i = 0; i < 5; i++) {
  ...
  // Define element properties
  book_img.src = back_end_books[i].imgPath;
  book_a.target = '_blank';
  book_a.href=back_end_books[i].imgLink;
  span_button1.textContent = 'Read';
  span_button2.textContent = 'Download';
  span_a1.href = back_end_books[i].imgLink;
  span_a1.target = '_blank';
