...
function paid_Book_data(name, price, author, rate, description,image) {
  ...
  const bnameArr2 = ['Learning Web Design: A Beginner\'s Guide to HTML, CSS, JavaScript, and Web Graphics 5th Edition',
...
const priceArr2 = [50.99, 40.99, 32.17,11.67,27.99,45.49, 45.49, 30.6, 16.89, 16.89, 19.55, 19.55, 16.89, 43.91, 16.89, 39.00, 39.00,22.00, 16.25, 16.25, 30.00, 45.47, 42.25, 31.99, 33.47,];
const authorArr2 = ['Jennifer Robbins','David DuRocher','Elisabeth Robson','LCF Publishing','Ben Frain', 'David Flanagan', 'Marijn Haverbeke', 'Marijn Haverbeke', 'code quickly', 
...
const rateArr2 = [4.5, 5,4.6,4.5,4.7, 4.7, 4.6, 4.6, 4.7, 4, 4.5, 4.6, 4.6, 4.5, 4.6, 4.8, 4.8, 4.3, 4.4, 4.4, 4.6, 4.5, 4.6, 4.8, 4.4,];
...
const imageArr2 =['./images/Learning Web Design.jpg',  // 0
...
for (let i = 0;i<bnameArr2.length;i++){
  paid_Book.push(new paid_Book_data(bnameArr2[i],priceArr2[i],authorArr2[i],rateArr2[i],descriptionArr2[i],imageArr2[i]));
}
